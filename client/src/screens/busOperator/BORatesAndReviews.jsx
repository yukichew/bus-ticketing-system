...
import { OneStarReviews, TwoStarsReviews, ThreeStarsReviews, FourStarsReviews, FiveStarsReviews } from '../../constants/Dummy';
...
const BORatesAndReviews = () => {
    ...
    const [selectedStartMonth, setSelectedStartMonth] = useState('Select Start Month');
    ...
    const [selectedStartYear, setSelectedStartYear] = useState('Select Start Year');
    ...
    const reviewTypes = [
        { type: 'overview', label: 'Overview', count: OneStarReviews.length + TwoStarsReviews.length + ThreeStarsReviews.length + FourStarsReviews.length + FiveStarsReviews.length },
        ...
        <>
            ...
            <div className='w-4/5 mt-8 mb-8 mx-auto'>
                <div className='flex items-center justify-between'>
                    ...
                    <button className='flex items-center border-2 border-gray-100 text-black text-sm font-poppins font-medium rounded-lg px-4 py-2' onClick={() => setIsFilterShow(prev => !prev)}>
                        ...
                        <Card>
                            <div className="flex items-center justify-between gap-4">
                                <div className="relative inline-block text-left w-1/2">
                                    <label htmlFor="startMonth" className="block text-md font-poppins font-medium text-gray-700">Start Month</label>
                                    <button
                                ...
                                <div className="relative inline-block text-left w-1/4">
                                    <label htmlFor="startYear" className="block text-md font-poppins font-medium text-gray-700">Start Year</label>
                                    <button
                                ...
                                <div className="relative inline-block text-left w-1/2">
                                    <label htmlFor="endMonth" className="block text-md font-poppins font-medium text-gray-700">End Month</label>
                                    <button
                                ...
                                <div className="relative inline-block text-left w-1/4">
                                    <label htmlFor="endYear" className="block text-md font-poppins font-medium text-gray-700">End Year</label>
                                    <button
                ...
                <div className='mt-5 flex flex-col md:flex-row justify-between'>
                    <div className='w-full md:w-1/3 flex flex-col'>
                        <div className='w-full text-center md:text-left px-4 py-2'>
                            <p className='font-poppins font-medium text-lg text-gray-500 mb-1'>Total Reviews</p>
                            <div className='flex items-center justify-center md:justify-start'>
                                <p className='font-poppins font-semibold text-4xl text-primary'>3,856</p><p className='font-poppins font-semibold text-sm text-primary mt-3 ml-1'>comments</p>
                            </div>
                        </div>

                        <div className='w-full text-center md:text-left px-4 py-2'>
                            <p className='font-poppins font-medium text-lg text-gray-500 mb-1'>Average Rating</p>
                            <div className='flex items-center justify-center md:justify-start'>
                                <p className='font-poppins font-semibold text-4xl text-primary mr-3'>4.0</p>
                                <Stars rating={4} />
                            </div>
                            <p className='font-poppins text-sm text-gray-400'>Average rating on this year</p>
                        </div>
                    </div>
                    ...
                    <div className='w-full md:w-2/3 h-auto px-4 py-2'>
                        <div>
                            <p className='font-poppins font-medium text-lg text-gray-500 mb-4'>Rating Summary</p>
                ...
                <div>
                    ...
                    <div className='mt-3 mb-4 flex space-x-3'>
                        {reviewTypes.map(({ type, label, count }) => (
                            <button
                                key={type}
                                className={`relative px-5 py-2 font-poppins rounded-lg border ${selectedReview === type ? 'border-primary bg-primary text-white' : 'border-gray-300 text-gray-400'} ${selectedReview === type ? '' : 'hover:border-2 hover:border-primary hover:text-primary hover:font-medium'}`}
                    ...
                    <div>
                        {selectedReview === 'five' && FiveStarsReviews.map((review) => (
                            <Review key={review.id} review={review} />
                        ))}
                        {selectedReview === 'four' && FourStarsReviews.map((review) => (
                            <Review key={review.id} review={review} />
                        ))}
                        {selectedReview === 'three' && ThreeStarsReviews.map((review) => (
                            <Review key={review.id} review={review} />
                        ))}
                        {selectedReview === 'two' && TwoStarsReviews.map((review) => (
                            <Review key={review.id} review={review} />
                        ))}
                        {selectedReview === 'one' && OneStarReviews.map((review) => (
                            <Review key={review.id} review={review} />
                        ))}
