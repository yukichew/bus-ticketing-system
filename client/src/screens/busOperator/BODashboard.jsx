...
const BODashboard = () => {
    ...
    const formattedTravelDate = currentDate.toISOString().split('T')[0];
    const [isFilterShow, setIsFilterShow] = useState(false);
    const [totalBuses, setTotalBuses] = useState('');
    const [totalRevenue, setTotalRevenue] = useState('');
    const [totalRatesAndReview, setTotalRatesAndReview] = useState('');
    ...
    const fetchBusScheduleData = async () => {
      try {
          const results = await getBusSchedulesForToday(token);
    ...
    const handleSearch = async () => {
      ...
      try {
          const results = await searchTodaySchedule(activeFilters, token);
                  ...
                  <div className="flex items-center justify-between">
                      <div className="flex items-center">
                          ...
                          <div>
                              ...
                              <p className="font-poppins font-medium text-xl text-primary">{totalBuses}</p>
                          </div>
                      </div>
                      <Link
                          to='/bo/bus'
              ...
              <Card bgColor='bg-violet-50'>
                <div className='flex items-center justify-between'>
                  <div className='flex items-center'>
                    ...
                    <div>
                      <h2 className='font-poppins font-bold text-md text-black mb-1'>
                        Total Rates & Reviews
                      </h2>
                        ...
                        <div className='mb-8 -mt-5'>
                          <Card>
                              ...
                              <div className="flex justify-between gap-8 mt-3">
                                  ...
                                  <div ref={statusDropdownRef} className="relative inline-block text-left w-1/2 pl-3">
