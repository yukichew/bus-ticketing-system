...
const BODashboard = () => {
  ...
  const formatSeats = (seatsSold, seatsLeft) => {
    if (seatsLeft === 0) {
      return (
        <span className='font-poppins text-gray-400 font-medium italic'>
          Sold Out
        </span>
      );
    }
    ...
    <Container>
      ...
      <div className='w-4/5 mt-5 mb-10 mx-auto'>
        <Card
          header={
            <>
              <span>{`Today's Bus Schedule`}</span>{' '}
              <span className='text-gray-400 ml-2 font-poppins '>
                {formattedDate}
              </span>
            </>
          }
              ...
              <Card>
                ...
                <div className='flex justify-between gap-4 mt-3'>
                  ...
                  <div className='w-1/3 pl-2'>
                    <label className='block text-md font-poppins font-medium text-gray-700'>
                      Status
                    </label>
                    <select className='mt-2 block w-full border border-gray-300 text-sm font-poppins rounded-lg p-2 bg-white'>
          ...
          <div className='flex justify-between items-center mt-5'>
            ...
            <div className='flex justify-end items-center'>
              <button
                ...
                onClick={() => handleNavigate('newSchedule')}
              >
