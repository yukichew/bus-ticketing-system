        ...
        <div className='grid grid-cols-2 gap-8 lg:grid-cols-4'>
          <div className='col-span-2 sm:col-span-1'>
            ...
            <p className='mt-3 text-sm font-poppins text-gray-500'>
              Est elitr takimata nonumy amet sadipscing dolor ea elitr et, kasd
              justo aliquyam magna justo, amet invidunt tempor sanctus.
            </p>
          </div>

          <div className='col-span-2 sm:col-span-1'>
            <p className='font-semibold text-tertiary font-poppins'>Company</p>
